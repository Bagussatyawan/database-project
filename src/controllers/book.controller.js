    ...
    Book.update(req.body, {
        ...
        .then(num => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot update Book with id=${id}. Maybe Book
    ...
    Book.destroy({
        ...
        .then(num => {
            if (num == 1) {
                ...
                res.send({
                    message: `Cannot delete Book with id=${id}. Maybe Book
                              was not found!`
                });
            }
        })
...
exports.deleteAll = (req, res) => {
    Book.destroy({
        ...
        .catch(err => {
            res.status(500).send({
                message: err.message || 'Some error occured while removing all books.'
            })
        })
};
